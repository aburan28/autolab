...
static const shared_group_t groups[] = {
  {9803ULL, 0ULL, 1ULL, 1ULL, 9791ULL, 9782ULL, 4979ULL, 2476ULL, 3749ULL, 7300ULL, 7833ULL, 0, 24},
  {9803ULL, 0ULL, 1ULL, 1ULL, 9791ULL, 9782ULL, 4979ULL, 7537ULL, 8016ULL, 2558ULL, 6741ULL, 24, 8},
};
